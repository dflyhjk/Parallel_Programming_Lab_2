...
if (inputB == NULL) {
    ...
    char outputFolder[] = "E:\\Parallel_Programming\\lab_1\\multiple\\mtrx_omp\\";
    ...
    // Запись времени и потоков в файл для графика
    FILE *timing = fopen("E:\\Parallel_Programming\\lab_1\\multiple\\timing_omp\\time_log.txt", "a");
