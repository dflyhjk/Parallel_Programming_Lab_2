...
def run_c_program():
    subprocess.run([f"E:\\Parallel_Programming\\lab_1\\multiple\\main_omp.exe"], cwd=r"E:\Parallel_Programming\lab_1\multiple", check=True)
...
def compare(N):
    ...
    C = read_matrix(f"E:\\Parallel_Programming\\lab_1\\multiple\\mtrx_omp\\C{N}.txt", N)
